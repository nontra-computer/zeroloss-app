...
const Filter: React.FC<Props> = ({
	...
	return (
		<div
			...
			data-kt-drawer-toggle="#kt_report_event_filter_toggle"
			data-kt-drawer-close="#kt_report_event_filter_close"
			style={{ zIndex: 9999 }}>
				...
				<div className="card-header pe-5">
					...
					<div className="card-toolbar">
						...
						<button
							...
							id="kt_report_event_filter_close">
							<KTSVG
